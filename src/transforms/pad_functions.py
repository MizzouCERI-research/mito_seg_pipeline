...
# # %%
# a = torch.ones(2, 25, 4, 300, 5)
# b = torch.ones(2, 22, 4, 300, 5)
# c = torch.ones(2, 15, 4, 300, 5)

# # %%
# type(a)

# # %%
# a = torch.ones(96, 64, 64, 4, 3)
# b = torch.ones(128, 64, 64, 4, 3)
# c = torch.ones(120, 64, 64, 4, 3)

# # %%
# pad_sequence([a, b, c], batch_first=False).size()
...
# # %%
# d = pad_sequence([a, b, c], batch_first=False)
# d.shape


# # %%
# d = d.permute(1, 2, 0, 3, 4, 5)
# d.shape

# # %%
# # d = pack_padded_sequence([a, b, c], lengths=100, batch_first=False, )
# # d.shape
